...
const cap = JSON.parse(readFileSync('capacity-data-jan26.json', 'utf8'));
...
writeFileSync('C:/Users/guilh/projetos/clickup-activity-mcp/dashboard-capacity-jan26.html', html);
const kb = Math.round(html.length / 1024);
console.log(`Dashboard gerado!`);
console.log(`Arquivo: C:/Users/guilh/projetos/clickup-activity-mcp/dashboard-capacity-jan26.html`);
